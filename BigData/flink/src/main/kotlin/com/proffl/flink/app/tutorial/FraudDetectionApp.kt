...
import com.proffl.flink.source.RuleSource
...
fun main(args: Array<String>) {
    ...
    var transactionsStringStream =
        env.addSource(TransactionSource.createTransactionSource(config)).name("transaction source")
