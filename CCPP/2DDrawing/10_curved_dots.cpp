// Compile: clang++ -std=c++20 10_curved_dots.cpp -o 10_curved_dots
...
int main()
{
    ...
    // Draw dots in a line with Bezier.
    ...
    save_image(image,width,height,"10_curved_dots.ppm");
